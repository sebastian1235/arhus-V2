...
class AsignacionModel
{
    ...
    {
        $stmt = Conexion::conectar()->prepare("SELECT id_asignacion, tipo_asignacion, comision_obra_asignacion, comision_gasod_asignacion, comision_fija_asignacion FROM $tabla where eliminar='0'");
        $stmt->execute();
    ...
    public function EliminarAsignacion($datosModel, $tabla)
    {
        $stmt = Conexion::conectar()->prepare("UPDATE $tabla  SET eliminar=:eliminar where id_asignacion=:id_asignacion");
