...
#Vista Asigancion
    ...
    public function programarSolicitud($datosModel, $tabla)
    {
        ...
        $stmt->bindParam(":nombre_estado_preventa", $datosModel["EditarnombreEstadoPreventa"], PDO::PARAM_STR);
