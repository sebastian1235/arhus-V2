...
-- Volcando datos para la tabla arhus.ap_asignacion: 7 rows
...
-- Volcando datos para la tabla arhus.ap_estado_preventa: 28 rows
...
-- Volcando datos para la tabla arhus.ap_items_inv: 341 rows
...
INSERT INTO `ap_solicitud` (`id_sol`, `poliza_sol`, `demanda_sol`, `asesor_sol`, `archivos_sol`, `asignacion_sol`, `comis_gas_sol`, `comis_obra_sol`, `comis_fija_sol`, `cedula_sol`, `nombre_sol`, `direccion_pol_sol`, `direccion_nueva_sol`, `barrio_sol`, `telefono1_sol`, `telefono2_sol`, `celular_sol`, `email_sol`, `servicio_sol`, `texto_sol`, `registra_sol`, `unidad_sol`, `fecha_reg_sol`, `obs_sol`, `empresa_sol`, `estado_sol`, `fecha_prevista_sol`, `user_preventa_sol`, `quincena_obra_sol`, `fecha_obra_sol`, `nombre_tecnico_sol`, `cod_tecnico_sol`, `lider_obra_sol`, `fecha_visita_comerc_sol`, `obs_estado_sol`, `tipo_clientegn_sol`, `forma_pagogn_sol`, `localidad_sol`) VALUES
	(0, 0, 0, 0, NULL, 0, 0.000000, 0.000000, NULL, 0, '', '', '', 0, '', '', '', '', '', 'Inscripcion CI', NULL, NULL, '2018-03-02 15:32:21', '', NULL, 0, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '', NULL, 0, 0),
	(2, 20, 20, 0, NULL, 12, 0.000000, 0.000000, NULL, 0, 'fsdf', 'ca2', 'fsf', 0, '32335545', '3554546', '34654654', 'fsfsdfa@gamil.com', '45646', 'Inscripcion CI', NULL, NULL, '2018-03-02 15:36:23', 'fsaa', NULL, 0, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '223', NULL, 0, 0),
	(12, 0, 0, 0, NULL, 0, 0.000000, 0.000000, NULL, 0, '', '', '', 0, '', '', '', '', '', 'Inscripcion CI', NULL, NULL, '2018-03-02 15:39:52', '', NULL, 0, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '', NULL, 0, 0),
	(30, 0, 0, 0, NULL, 0, 0.000000, 0.000000, NULL, 0, '', '', '', 0, '', '', '', '', '', 'Inscripcion CI', NULL, NULL, '2018-03-02 15:41:30', '', NULL, 0, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '', NULL, 0, 0),
	(40, 0, 0, 0, NULL, 0, 0.000000, 0.000000, NULL, 0, '', '', '', 0, '', '', '', '', '', 'Inscripcion CI', NULL, NULL, '2018-03-02 15:41:57', '', NULL, 0, '0000-00-00 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00 00:00:00', '', NULL, 0, 0);
...
-- Volcando datos para la tabla arhus.ap_terceros: 0 rows
...
-- Volcando datos para la tabla arhus.siax_campana: 29 rows
...
-- Volcando datos para la tabla arhus.siax_localidad: ~0 rows (aproximadamente)
...
-- Volcando datos para la tabla arhus.siax_medio_pago: 5 rows
...
-- Volcando datos para la tabla arhus.siax_sectores: ~246 rows (aproximadamente)
/*!40000 ALTER TABLE `siax_sectores` DISABLE KEYS */;
INSERT INTO `siax_sectores` (`cod_sec`, `nombre_sec`) VALUES
	(1, 'centro  '),
	(2, 'camilo torres'),
	(3, 'compartir  '),
	(4, 'leon xiii'),
	...
	(24, 'primavera'),
	(25, 'delicias'),
	(26, 'alqueria la fragua'),
	(27, 'carvajal'),
	(28, 'villa claudia'),
	(29, 'igualdad'),
	(30, 'hipotecho'),
	(31, 'isla del sol'),
	(32, 'rincon de venecia'),
	(33, 'zona industrial'),
	(34, 'acacia'),
	(35, 'san francisco'),
	(36, 'candelaria'),
	(37, 'arborizadora baja'),
	(38, 'fatima'),
	(39, 'venecia'),
	(40, 'samore'),
	(41, 'vicente ferrer'),
	...
	(64, 'claret'),
	(65, 'santa lucia'),
	(66, 'parque central bavaria'),
	(67, 'acevedo'),
	(68, 'rafael nu?ez\r'),
	(69, 'nicolas de federman'),
	(70, 'compensar'),
	(71, 'los rosales'),
	(72, 'ciudadela colsubsidio'),
	(73, 'bolivia'),
	(74, 'santa paula'),
	(106, 'pasadena'),
	(107, 'canaima'),
	(108, 'bellavista'),
	(109, 'monteblanco'),
	(110, 'antonio jose sucre'),
	(111, 'alfonso lopez'),
	(112, 'puerta del llano'),
	(113, 'rincon de santafe'),
	(114, 'perdomo alto'),
	(115, 'santa ana'),
	(116, 'terreros'),
	(117, 'marco fidel suarez'),
	(118, 'j.j. rendon'),
	(119, 'santa barbara'),
	(120, 'villa de aranjuez'),
	(121, 'calvo sur'),
	(122, 'mexico'),
	(123, 'bosques de san mateo'),
	(124, 'villabosa'),
	(125, 'ricaurte'),
	(126, 'san mateo'),
	(127, 'el triunfo'),
	...
	(133, 'san jose'),
	(134, 'carbonell'),
	(135, 'recodo de puntaloma'),
	(136, 'nueva granada'),
	(137, 'lucero'),
	(138, 'vista hermosa'),
	(139, 'colina campestre'),
	(140, 'tejares del norte'),
	(141, 'san ignacio'),
	(142, 'los angeles'),
	(143, 'bilbao'),
	(144, 'nutibara'),
	...
	(146, 'san jorge'),
	(147, 'arborizadora'),
	(148, 'arborizadora alta'),
	(149, 'parque metropolitano'),
	(150, 'kenedy oriental'),
	(151, 'la esperanza'),
	(152, 'parque la roca'),
	(153, 'el vergel'),
	(154, 'san jose de meryland'),
	(155, 'san antonio'),
	(156, 'capellania'),
	(157, 'francisco miranda'),
	(158, 'montevideo'),
	(159, 'potosi'),
	(160, 'las cruces'),
	(161, 'la esmeralda'),
	...
	(164, 'j.j. vargas'),
	(165, 'niza ix'),
	(166, 'rincon de modelia'),
	(167, 'chircales'),
	(168, 'sierra morena'),
	(169, 'humberto valencia'),
	(170, 'contador'),
	(171, 'san miguel'),
	(172, 'santa isabel'),
	(173, 'buenos aires'),
	...
	(224, 'soledad norte'),
	(225, 'tabora'),
	(226, 'santa maria del lago'),
	(227, 'bonanza'),
	(228, 'ferias occidental'),
	(229, 'metropolis'),
	(230, 'san fernando'),
	(231, 'doce de octubre'),
	(232, 'gaitan'),
	...
	(249, 'cedritos'),
	(250, 'la cumbre'),
	(251, 'republica de venezuela'),
	(252, 'altos de sotavento'),
	(253, 'villa gloria'),
	(254, 'villa flor'),
	(255, 'el progreso'),
	(256, 'terreros'),
	...
	(272, 'autodromo'),
	(273, 'villa del prado'),
	(274, 'san jose de bavaria'),
	(275, 'zona franca'),
	(276, 'san luis'),
	(277, 'quinta paredes');
/*!40000 ALTER TABLE `siax_sectores` ENABLE KEYS */;

-- Volcando estructura para tabla arhus.usuarios
