...
$ap_tipo_cliente_edit = NULL; // Initialize page object first

class cap_tipo_cliente_edit extends cap_tipo_cliente {
	...
	// Page object name
	var $PageObjName = 'ap_tipo_cliente_edit';
	...
	function Page_Main() {
		...
		// Check if valid key
		if ($this->id_tipo_cliente->CurrentValue == "") {
			$this->Page_Terminate("ap_tipo_clientelist.php"); // Invalid key, return to list
		}
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$this->nombre_tipo_cliente->SetDbValueDef($rsnew, $this->nombre_tipo_cliente->CurrentValue, NULL, $this->nombre_tipo_cliente->ReadOnly);

			// detalle_tipo_cliente
			$this->detalle_tipo_cliente->SetDbValueDef($rsnew, $this->detalle_tipo_cliente->CurrentValue, NULL, $this->detalle_tipo_cliente->ReadOnly);

			// activo_tipo_cliente
			$this->activo_tipo_cliente->SetDbValueDef($rsnew, $this->activo_tipo_cliente->CurrentValue, NULL, $this->activo_tipo_cliente->ReadOnly);

			// empresa_tipo_cliente
			$this->empresa_tipo_cliente->SetDbValueDef($rsnew, $this->empresa_tipo_cliente->CurrentValue, NULL, $this->empresa_tipo_cliente->ReadOnly);
...
// Create page object
if (!isset($ap_tipo_cliente_edit)) $ap_tipo_cliente_edit = new cap_tipo_cliente_edit();

// Page init
$ap_tipo_cliente_edit->Page_Init();

// Page main
$ap_tipo_cliente_edit->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ap_tipo_cliente_edit->Page_Render();
?>
...
var CurrentForm = fap_tipo_clienteedit = new ew_Form("fap_tipo_clienteedit", "edit");

// Validate form
fap_tipo_clienteedit.Validate = function() {
...
fap_tipo_clienteedit.Form_CustomValidate = 
...
fap_tipo_clienteedit.ValidateRequired = true;
<?php } else { ?>
fap_tipo_clienteedit.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$ap_tipo_cliente_edit->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $ap_tipo_cliente_edit->ShowPageHeader(); ?>
<?php
$ap_tipo_cliente_edit->ShowMessage();
?>
<form name="fap_tipo_clienteedit" id="fap_tipo_clienteedit" class="<?php echo $ap_tipo_cliente_edit->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ap_tipo_cliente_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ap_tipo_cliente_edit->Token ?>">
<?php } ?>
...
<p class="form-control-static"><?php echo $ap_tipo_cliente->id_tipo_cliente->EditValue ?></p></span>
</span>
<input type="hidden" data-table="ap_tipo_cliente" data-field="x_id_tipo_cliente" name="x_id_tipo_cliente" id="x_id_tipo_cliente" value="<?php echo ew_HtmlEncode($ap_tipo_cliente->id_tipo_cliente->CurrentValue) ?>">
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ap_tipo_cliente_edit->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fap_tipo_clienteedit.Init();
</script>
<?php
$ap_tipo_cliente_edit->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ap_tipo_cliente_edit->Page_Terminate();
?>
