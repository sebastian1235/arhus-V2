...
$ap_tipo_inv_add = NULL; // Initialize page object first

class cap_tipo_inv_add extends cap_tipo_inv {
	...
	// Page object name
	var $PageObjName = 'ap_tipo_inv_add';
	...
	function Page_Main() {
		...
		if (@$_POST["a_add"] <> "") {
			...
			if (@$_GET["id_tipo_inv"] != "") {
				...
				$this->setKey("id_tipo_inv", $this->id_tipo_inv->CurrentValue); // Set up key
			} else {
				$this->setKey("id_tipo_inv", ""); // Clear key
		...
		switch ($this->CurrentAction) {
			...
			case "A": // Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					elseif (ew_GetPageName($sReturnUrl) == "ap_tipo_invview.php")
	...
	function LoadDefaultValues() {
		$this->id_tipo_inv->CurrentValue = NULL;
		$this->id_tipo_inv->OldValue = $this->id_tipo_inv->CurrentValue;
		$this->nombre_tipo_inv->CurrentValue = NULL;
		$this->nombre_tipo_inv->OldValue = $this->nombre_tipo_inv->CurrentValue;
		$this->venta_tipo_inv->CurrentValue = NULL;
		$this->venta_tipo_inv->OldValue = $this->venta_tipo_inv->CurrentValue;
		$this->activo_tipo_inv->CurrentValue = 1;
		$this->global_tipo_inv->CurrentValue = NULL;
		$this->global_tipo_inv->OldValue = $this->global_tipo_inv->CurrentValue;
		$this->grupo_tipo_inv->CurrentValue = NULL;
		$this->grupo_tipo_inv->OldValue = $this->grupo_tipo_inv->CurrentValue;
		$this->empresa_tipo_inv->CurrentValue = NULL;
		$this->empresa_tipo_inv->OldValue = $this->empresa_tipo_inv->CurrentValue;
	}
	...
	function RenderRow() {
		...
		$this->empresa_tipo_inv->ViewCustomAttributes = "";
			...
			$this->id_tipo_inv->EditValue = ew_HtmlEncode($this->id_tipo_inv->CurrentValue);
			$this->id_tipo_inv->PlaceHolder = ew_RemoveHtml($this->id_tipo_inv->FldCaption());
	...
	function AddRow($rsold = NULL) {
		...
		if ($this->nombre_tipo_inv->CurrentValue <> "") { // Check field with unique index
			$sFilter = "(nombre_tipo_inv = '" . ew_AdjustSql($this->nombre_tipo_inv->CurrentValue, $this->DBID) . "')";
		...
		// id_tipo_inv
		$this->id_tipo_inv->SetDbValueDef($rsnew, $this->id_tipo_inv->CurrentValue, 0, FALSE);

		// nombre_tipo_inv
		$this->nombre_tipo_inv->SetDbValueDef($rsnew, $this->nombre_tipo_inv->CurrentValue, "", FALSE);

		// venta_tipo_inv
		$this->venta_tipo_inv->SetDbValueDef($rsnew, $this->venta_tipo_inv->CurrentValue, NULL, FALSE);

		// activo_tipo_inv
		$this->activo_tipo_inv->SetDbValueDef($rsnew, $this->activo_tipo_inv->CurrentValue, NULL, strval($this->activo_tipo_inv->CurrentValue) == "");

		// global_tipo_inv
		$this->global_tipo_inv->SetDbValueDef($rsnew, $this->global_tipo_inv->CurrentValue, NULL, FALSE);

		// grupo_tipo_inv
		$this->grupo_tipo_inv->SetDbValueDef($rsnew, $this->grupo_tipo_inv->CurrentValue, NULL, FALSE);

		// empresa_tipo_inv
		$this->empresa_tipo_inv->SetDbValueDef($rsnew, $this->empresa_tipo_inv->CurrentValue, NULL, FALSE);
		...
		if ($bInsertRow && $this->ValidateKey && strval($rsnew['id_tipo_inv']) == "") {
...
// Create page object
if (!isset($ap_tipo_inv_add)) $ap_tipo_inv_add = new cap_tipo_inv_add();

// Page init
$ap_tipo_inv_add->Page_Init();

// Page main
$ap_tipo_inv_add->Page_Main();

// Global Page Rendering event (in userfn*.php)
Page_Rendering();

// Page Rendering event
$ap_tipo_inv_add->Page_Render();
?>
...
var CurrentForm = fap_tipo_invadd = new ew_Form("fap_tipo_invadd", "add");

// Validate form
fap_tipo_invadd.Validate = function() {
...
fap_tipo_invadd.Form_CustomValidate = 
...
fap_tipo_invadd.ValidateRequired = true;
<?php } else { ?>
fap_tipo_invadd.ValidateRequired = false; 
<?php } ?>
...
<?php if (!$ap_tipo_inv_add->IsModal) { ?>
<div class="ewToolbar">
...
<?php } ?>
<?php $ap_tipo_inv_add->ShowPageHeader(); ?>
<?php
$ap_tipo_inv_add->ShowMessage();
?>
<form name="fap_tipo_invadd" id="fap_tipo_invadd" class="<?php echo $ap_tipo_inv_add->FormClassName ?>" action="<?php echo ew_CurrentPage() ?>" method="post">
<?php if ($ap_tipo_inv_add->CheckToken) { ?>
<input type="hidden" name="<?php echo EW_TOKEN_NAME ?>" value="<?php echo $ap_tipo_inv_add->Token ?>">
<?php } ?>
...
<input type="text" data-table="ap_tipo_inv" data-field="x_id_tipo_inv" name="x_id_tipo_inv" id="x_id_tipo_inv" size="30" placeholder="<?php echo ew_HtmlEncode($ap_tipo_inv->id_tipo_inv->getPlaceHolder()) ?>" value="<?php echo $ap_tipo_inv->id_tipo_inv->EditValue ?>"<?php echo $ap_tipo_inv->id_tipo_inv->EditAttributes() ?>>
</span>
...
<button class="btn btn-default ewButton" name="btnCancel" id="btnCancel" type="button" data-href="<?php echo $ap_tipo_inv_add->getReturnUrl() ?>"><?php echo $Language->Phrase("CancelBtn") ?></button>
	</div>
</div>
<?php } ?>
</form>
<script type="text/javascript">
fap_tipo_invadd.Init();
</script>
<?php
$ap_tipo_inv_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$ap_tipo_inv_add->Page_Terminate();
?>
