...
define("EW_PROJECT_NAME", "arhus", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{6A9AC718-A824-45A3-BED3-A95E91E6986D}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'bsHKCxxx97ky7sWX', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/arhus.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "mysql", "db" => "arhusphpMaker", "qs" => "`", "qe" => "`");
...
define("EW_USER_PROFILE_PASSWORD_EXPIRE", 30, TRUE);
...
define("EW_SENDER_EMAIL", "admin@ticsia.com", TRUE); // Sender email address
