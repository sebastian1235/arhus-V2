...
fusuariosdelete.Lists["x_rol"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuariosdelete.Lists["x_rol"].Options = <?php echo json_encode($usuarios->rol->Options()) ?>;
...
<?php if ($usuarios->intentos->Visible) { // intentos ?>
		<th><span id="elh_usuarios_intentos" class="usuarios_intentos"><?php echo $usuarios->intentos->FldCaption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($usuarios->intentos->Visible) { // intentos ?>
		<td<?php echo $usuarios->intentos->CellAttributes() ?>>
<span id="el<?php echo $usuarios_delete->RowCnt ?>_usuarios_intentos" class="usuarios_intentos">
<span<?php echo $usuarios->intentos->ViewAttributes() ?>>
<?php echo $usuarios->intentos->ListViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($usuarios->Activo->Visible) { // Activo ?>
