...
class cusuarios_list extends cusuarios {
	...
	function GetFilterList() {
		...
		$sFilterList = ew_Concat($sFilterList, $this->intentos->AdvancedSearch->ToJSON(), ","); // Field intentos
		$sFilterList = ew_Concat($sFilterList, $this->Activo->AdvancedSearch->ToJSON(), ","); // Field Activo
		$sFilterList = ew_Concat($sFilterList, $this->Perfil->AdvancedSearch->ToJSON(), ","); // Field Perfil
		if ($this->BasicSearch->Keyword <> "") {
	...
	function RestoreFilterList() {
		...
		// Field intentos
		$this->intentos->AdvancedSearch->SearchValue = @$filter["x_intentos"];
		$this->intentos->AdvancedSearch->SearchOperator = @$filter["z_intentos"];
		$this->intentos->AdvancedSearch->SearchCondition = @$filter["v_intentos"];
		$this->intentos->AdvancedSearch->SearchValue2 = @$filter["y_intentos"];
		$this->intentos->AdvancedSearch->SearchOperator2 = @$filter["w_intentos"];
		$this->intentos->AdvancedSearch->Save();
	...
	function BasicSearchSQL($arKeywords, $type) {
		...
		$this->BuildBasicSearchSQL($sWhere, $this->Perfil, $arKeywords, $type);
		return $sWhere;
	}
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$this->UpdateSort($this->intentos); // intentos
	...
	function SetupOtherOptions() {
		...
		$item->Body = "<a class=\"ewAction ewMultiDelete\" title=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" data-caption=\"" . ew_HtmlTitle($Language->Phrase("DeleteSelectedLink")) . "\" href=\"\" onclick=\"ew_SubmitAction(event,{f:document.fusuarioslist,url:'" . $this->MultiDeleteUrl . "'});return false;\">" . $Language->Phrase("DeleteSelectedLink") . "</a>";
		$item->Visible = ($Security->CanDelete());
...
fusuarioslist.Lists["x_rol"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuarioslist.Lists["x_rol"].Options = <?php echo json_encode($usuarios->rol->Options()) ?>;
...
<?php if ($usuarios->id->Visible) { // id ?>
	...
	<?php } else { ?>
		<th data-name="id"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->id) ?>',1);"><div id="elh_usuarios_id" class="usuarios_id">
...
<?php if ($usuarios->rol->Visible) { // rol ?>
	...
	<?php } else { ?>
		<th data-name="rol"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->rol) ?>',1);"><div id="elh_usuarios_rol" class="usuarios_rol">
...
<?php if ($usuarios->intentos->Visible) { // intentos ?>
	<?php if ($usuarios->SortUrl($usuarios->intentos) == "") { ?>
		<th data-name="intentos"><div id="elh_usuarios_intentos" class="usuarios_intentos"><div class="ewTableHeaderCaption"><?php echo $usuarios->intentos->FldCaption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="intentos"><div class="ewPointer" onclick="ew_Sort(event,'<?php echo $usuarios->SortUrl($usuarios->intentos) ?>',1);"><div id="elh_usuarios_intentos" class="usuarios_intentos">
			<div class="ewTableHeaderBtn"><span class="ewTableHeaderCaption"><?php echo $usuarios->intentos->FldCaption() ?></span><span class="ewTableHeaderSort"><?php if ($usuarios->intentos->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($usuarios->intentos->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span></div>
        </div></div></th>
	<?php } ?>
<?php } ?>		
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_rol" class="usuarios_rol">
...
<?php echo $usuarios->rol->ListViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($usuarios->intentos->Visible) { // intentos ?>
		<td data-name="intentos"<?php echo $usuarios->intentos->CellAttributes() ?>>
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_intentos" class="usuarios_intentos">
...
<span id="el<?php echo $usuarios_list->RowCnt ?>_usuarios_Activo" class="usuarios_Activo">
