...
var CurrentForm = fusuariosview = new ew_Form("fusuariosview", "view");
...
fusuariosview.Lists["x_rol"] = {"LinkField":"","Ajax":null,"AutoFill":false,"DisplayFields":["","","",""],"ParentFields":[],"ChildFields":[],"FilterFields":[],"Options":[],"Template":""};
fusuariosview.Lists["x_rol"].Options = <?php echo json_encode($usuarios->rol->Options()) ?>;
...
<?php if ($usuarios->photo->Visible) { // photo ?>
	<tr id="r_photo">
		<td><span id="elh_usuarios_photo"><?php echo $usuarios->photo->FldCaption() ?></span></td>
		<td data-name="photo"<?php echo $usuarios->photo->CellAttributes() ?>>
<span id="el_usuarios_photo">
<span<?php echo $usuarios->photo->ViewAttributes() ?>>
<?php echo $usuarios->photo->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($usuarios->intentos->Visible) { // intentos ?>
	<tr id="r_intentos">
		<td><span id="elh_usuarios_intentos"><?php echo $usuarios->intentos->FldCaption() ?></span></td>
...
<?php echo $usuarios->intentos->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($usuarios->Perfil->Visible) { // Perfil ?>
	<tr id="r_Perfil">
		<td><span id="elh_usuarios_Perfil"><?php echo $usuarios->Perfil->FldCaption() ?></span></td>
		<td data-name="Perfil"<?php echo $usuarios->Perfil->CellAttributes() ?>>
<span id="el_usuarios_Perfil">
<span<?php echo $usuarios->Perfil->ViewAttributes() ?>>
<?php echo $usuarios->Perfil->ViewValue ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php if ($usuarios_view->Pager->RecordCount > 0 && $usuarios_view->Pager->Visible) { ?>
<div class="ewPager">
